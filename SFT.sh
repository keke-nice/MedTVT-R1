...
python3 -u -m torch.distributed.launch --master_port=1117 --nproc_per_node=2 --use_env \
 main_train.py --batch_size 8 --accum_iter 1 --stage 3 \
 ...
 --output_dir "./ckpts/retrain_llama3.2_1B_8331_raw_data" --max_words 600 --llama_type llama3  \
 --model_type cardio_llama --add_special_token \
 --retrain --model_ckpt ./ckpts/pretrain_llama3.2_1B_8331_raw_data/checkpoint_19.pth
